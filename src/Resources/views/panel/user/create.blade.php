                        ...
                        <div class="card-block">
                            <form method="POST" action="{!! route('users.store') !!}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="{!! trans('cms::user.name') !!}" value="{!! old('name') !!}">
                                    @include('cms::panel.inc.form_error',['input_name' => 'name'])
                                </div>
                                <div class="form-group">
                                    <label>{!! trans('cms::user.email') !!}</label>
                                    <input type="email" class="form-control" id="email" name="email" placeholder="{!! trans('cms::user.email') !!}" value="{!! old('email') !!}">
                                ...
                                <div class="form-group page-date">
                                    <input type="submit" class="form-control btn-primary col-3" id="submit" value="{!! trans('cms::user.create') !!}">
                                </div>
                            </form>
                        </div>
                    </div>
