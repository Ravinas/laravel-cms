...
<div class="main-content container-fluid">
    <div class="page-title">
        <h3>{{ trans('cms::panel.edit_your_menus') }}</h3>
        <p class="text-subtitle text-muted">{{ trans('cms::panel.menu_dont_forgot') }}</p>
    </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class='card-heading p-1 pl-3 float-left'>{{ trans('cms::panel.languages') }}</h3>
