...
<div class="main-content container-fluid">
    <div class="card">
        <div class="card-header">
            <div class="card-body">
                <div class="divider">
                    <div class="divider-text">{!! trans('cms::page.subpages',['parent' => $parent->detail->name]) !!}</div>
                </div>
                <div class="row">
                    <div class="form-group">
                        <a class="btn icon icon-left btn-primary float-right" href="{!! route('pages.create',['page' => $parent_id]).'&type=subpage' !!}"><i data-feather="plus-circle"></i>{!! trans('cms::panel.create') !!}</a>
                    </div>
