                        ...
                        <div class="row">
                            <div class="row">
                                ...
                                <div class="col-9">
                                            ...
                                            @if ($pd->language)
                                                <div class="tab-pane fade {!! $loop->first ? 'show active' : '' !!}" id="v{!! $pd->id !!}" role="tabpanel" aria-labelledby="{!! $pd->id !!}-tab">
                                                    <div class="row justify-content-end">
                                                        <div class="from-group">
                                                            <div class="form-check form-switch  float-right">
                                                                <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault" name="detail_status[{!! $pd->language->id !!}]" value="1"  {!! $pd->status == 1 ? 'checked' : '' !!}>
                                                                <label class="form-check-label" for="flexSwitchCheckDefault">{!! trans('cms::panel.page_isactive') !!}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    @if($detail_extra_include)
                                                        @include($detail_extra_include)
                                                    @endif
                                                </div>
                                            @endif
                                        @endforeach
                                    ...
                                    @if($extra_include)
                                        <div class="divider">
                                            <div class="divider-text">{!! trans('cms::panel.non-lang-content') !!}</div>
                                        </div>
